...
from document_agent.composition._image_segment import crop_to_content
...
class TestExtractElement:
    def test_extract_element_crops_after_bg_removal(self):
        ...
        with patch(
            "document_agent.composition._image_segment.remove_background",
            return_value=png,
        ):
            from document_agent.composition._image_segment import extract_element

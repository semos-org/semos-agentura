...
class TestGenerateMode:
    ...
    async def test_generate_writes_png(self, tmp_path):
        from document_agent.composition._generate_image import generate_image
        ...
        with patch(
            "document_agent.composition._generate_image._build_image_client",
...
class TestCutMode:
    ...
    async def test_cut_vlm_guided(self, tmp_path):
        ...
        with (
            ...
            patch(
                "document_agent.composition._generate_image._build_vlm_client",
...
class TestMissingConfig:
    ...
    async def test_raises_without_endpoint(self, tmp_path):
        from document_agent.composition._generate_image import generate_image
        from document_agent.exceptions import ProviderError

...
from document_agent.forms.fill import fill_form, inspect_form, inspect_form_fields
...
class TestFillKeyResolver:
    ...
    def _svc(self):
        from document_agent.tools import _cache_form_resolver
    ...
    def test_label_key_maps_to_field_id(self, tmp_dir):
        from document_agent.tools import _resolve_fill_keys

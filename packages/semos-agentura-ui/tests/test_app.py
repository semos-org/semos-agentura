...
from semos.agentura.ui.mcp_hub import AgentConnection
...
class TestRegisterLitellmProvider:
    def test_idempotent(self):
        ...
        from semos.agentura.ui.__main__ import _register_litellm_provider
...
class TestWrapChatCallback:
    @pytest.fixture
    def setup(self):
        from semos.agentura.ui.__main__ import _wrap_chat_callback
    ...
    def test_create_app_succeeds(self, monkeypatch):
        ...
        from semos.agentura.ui.__main__ import create_app

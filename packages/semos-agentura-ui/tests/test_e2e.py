...
async def _make_hub(agent_info):
    from semos.agentura.ui.mcp_hub import AgentConnection, MCPHub
...
async def _discover_a2a(base_url):
    from semos.agentura.ui.a2a_client import discover_agents
...
class TestMCPTool:
    ...
    async def test_search_emails(self, email_agent):
        from semos.agentura.ui.mcp_tools import _make_mcp_tool_class
    ...
    async def test_compose_document_produces_file(self, doc_agent):
        from semos.agentura.ui.mcp_tools import (
...
class TestA2ATool:
    ...
    async def test_search_emails_via_a2a(self, email_agent):
        from semos.agentura.ui.a2a_client import send_tool_call
...
class TestA2ADelegate:
    ...
    async def test_delegate_email_search(self, email_agent):
        from semos.agentura.ui.a2a_tools import _make_a2a_delegate_tool
...
class TestDiscovery:
    ...
    async def test_mcp_and_a2a_from_same_agent(self, email_agent):
        ...
        from semos.agentura.ui.a2a_tools import create_a2a_delegates
    ...
    async def test_full_tool_registration(
        ...
        from semos.agentura.ui.a2a_tools import create_a2a_delegates
        from semos.agentura.ui.mcp_hub import AgentConnection, MCPHub
        from semos.agentura.ui.mcp_tools import create_mcp_tools

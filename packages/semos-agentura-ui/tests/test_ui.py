...
def full_app(page: Page):
    ...
    from semos.agentura.files.panel_tree import VFSTreeBrowser
    from semos.agentura.files.vfs import VirtualFileSystem
    from semos.agentura.ui.__main__ import _wrap_chat_callback, setup_chat_interface
    ...
    from semos.agentura.ui.__main__ import _build_tool_tree
...
def vfs_mcp_app(page: Page):
    ...
    from semos.agentura.core import create_app as create_agent_app
    from semos.agentura.files.panel_tree import VFSTreeBrowser
...
def test_vfs_mcp_roundtrip(vfs_mcp_app):
    ...
    from semos.agentura.core.mcp_client import (
        AgentConnection,
        MCPHub,
    )

...
from semos.agentura.document.composition._reference_doc import (
    generate_reference_doc,
    parse_styles_from_markdown,
)
from semos.agentura.document.digestion._styles import (
    extract_styles,
...
class TestStyleRoundTrip:
    def test_digest_extracts_styles_as_frontmatter(self, sample_reference_docx: Path, tmp_path: Path):
        from semos.agentura.document.digestion._docx_digest import digest_docx_with_pandoc
    ...
    def test_compose_uses_yaml_styles(self, tmp_path: Path):
        from semos.agentura.document.composition.compose import compose

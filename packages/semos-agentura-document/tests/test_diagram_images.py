...
from semos.agentura.document.composition._diagram_optimize import _build_initial_messages
from semos.agentura.document.composition._diagram_source import (
...
class TestDiagramImageStrippingIntegration:
    ...
    def test_extract_from_drawio_png(self, tmp_path: Path):
        ...
        from semos.agentura.document.composition._diagram_source import extract_diagram_source
...
class TestAutoSwitchToDrawio:
    ...
    async def test_embeds_force_drawio(self, tmp_path):
        from semos.agentura.document.composition._generate_diagram import generate_diagram
        ...
        with (
            patch(
                "semos.agentura.document.composition._generate_diagram.optimize_diagram",
                mock_optimize,
            ),
            patch(
                "semos.agentura.document.composition._generate_diagram.require_tool",
                return_value="drawio",
            ),
        ):

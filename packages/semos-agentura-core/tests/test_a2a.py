...
from semos.agentura.core.a2a_server import (
    _AgentExecutor,
    _extract_files,
    _extract_text,
    _extract_tool_call,
...
from semos.agentura.core.base import (
    AgentTool,
    BaseAgentService,
    SkillDef,
)
...
async def test_executor_with_file_output(service, tmp_path):
    ...
    async def _file_tool():
        from semos.agentura.core.base import NamedFile
...
async def test_executor_with_multiple_file_outputs(service, tmp_path):
    ...
    """
    from semos.agentura.core.base import NamedFile, ToolResult

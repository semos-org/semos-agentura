...
def test_write_file_mode_is_enum():
    ...
    from semos.agentura.files.tools import WriteFileInput, WriteMode
...
def test_write_file_required_in_schema():
    ...
    from semos.agentura.files.tools import WriteFileTool
...
def test_write_file_pydantic_rejects_missing_content():
    ...
    from pydantic import ValidationError
    from semos.agentura.files.tools import WriteFileInput

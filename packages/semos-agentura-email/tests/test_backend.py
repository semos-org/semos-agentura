...
import pytest
from semos.agentura.email.backend import (
    IMAPBackend,
    _com_dict_to_email,
    _com_dict_to_event,
    _parse_com_datetime,
...
from semos.agentura.email.exceptions import BackendNotAvailable
from semos.agentura.email.formatting import html_to_annotated_text, md_to_html, md_to_plain
from semos.agentura.email.models import EmailMessage, EventInfo
from semos.agentura.email.tools import (
    Recipient,
    _recipients_to_str,
    get_email_tools,
)
...
class TestFactory:
    ...
    def test_create_com_backend(self):
        ...
        try:
            ...
            b = create_backend(s)
            from semos.agentura.email.backend import COMBackend
